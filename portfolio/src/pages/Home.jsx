...
const Home = () => {
  ...
  return (
    <main className="w-full h-screen bg-[url('/bg-image-2.jpg')] bg-cover flex items-center justify-center">
      <div className="backdrop-blur-sm w-full h-full flex items-center justify-center p-4">
      <div className="w-[90%] min-w-screen-2xl h-[95vh] bg-gray-900/40 backdrop-blur-md rounded-2xl flex flex-col overflow-hidden">
        <NavBar
