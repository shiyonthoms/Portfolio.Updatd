const NavBar = ({ routeNames, currentRoute, setCurrentRoute }) => {
  return (
    <nav className="w-full flex items-center h-[72px] px-6">
      <div className="text-white font-bold text-2xl rounded-4xl pl-4 pr-4 pt-2 pb-2 bg-gray-700/40 hover:bg-gray-900/30 cursor-pointer">
        Shiyon Thomas
      </div>
